		...
		do
		{
			do
			{
				if (activeUid == 0)
				{
					...
					case ("groupadd"):
						System.out.print("Nazwa grupy: "); String g = sc.nextLine();
						root.groupadd(g);
						break;
						
					case ("groupaddus"):
						System.out.print("Nazwa grupy: "); String gr = sc.nextLine();
						System.out.print("Nazwa uzytkownika: "); String ur = sc.nextLine();
						root.groupAddUser(gr, ur);
						break;
